...
- **Display + body** — _Inter_ weights 400 / 500 / 600 with `font-feature-settings: "ss01"` enabled is the closest stylistic match.
- **Mono** — _Inconsolata_ (the documented fallback) or _DM Mono_.
