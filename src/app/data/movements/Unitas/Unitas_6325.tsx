...
const UNITAS_6325: Caliber = {
  title: "Unitas 6325",
  description:
    "Vintage mechanical movement with a small seconds subdial at 6:00. This caliber is often referred to as a military/army movement due to its common usage in such models. Typically found with 17 jewels, although some examples use 21 jewels.",
  usefullLinks: {
